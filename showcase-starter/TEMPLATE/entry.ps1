# {{DEMO_TITLE}} - Windows Auto-Launch Script
# This script automatically opens the demo in your default browser

Write-Host "🚀 Starting {{DEMO_TITLE}}..." -ForegroundColor Green
...
if ($serverReady) {
    ...
    Write-Host "🌐 Opening {{DEMO_TITLE}} in your browser..." -ForegroundColor Green
    Start-Process "http://localhost:8000"
    
    Write-Host ""
    Write-Host "🎉 {{DEMO_TITLE}} is now running!" -ForegroundColor Green
